...
function M.setup(config)
  ...
  theme.base = {
    ...
    Pmenu = { bg = util.darken(c.bg_dark, 0.45), fg = c.fg }, -- Popup menu: normal item.
  ...
  theme.plugins = {
    ...
    -- Telescope
    TelescopeBorder = { fg = c.border_highlight, bg = c.bg_sidebar },
    TelescopeNormal = { fg = c.fg, bg = c.bg_sidebar },
